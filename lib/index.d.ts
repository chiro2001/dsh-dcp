...
declare const Config: Schema<Schemastery.ObjectS<{
  ...
  compress: Schema<Schemastery.ObjectS<{
    enabled: Schema<boolean, boolean>;
  ...
  references: Schema<Schemastery.ObjectS<{
  ...
  nudge: Schema<Schemastery.ObjectS<{
    enabled: Schema<boolean, boolean>;
  ...
  manualMode: Schema<Schemastery.ObjectS<{
  ...
  strategies: Schema<Schemastery.ObjectS<{
    deduplication: Schema<Schemastery.ObjectS<{
      enabled: Schema<boolean, boolean>;
      protectedTools: Schema<string[], string[]>;
    }>, Schemastery.ObjectT<{
      enabled: Schema<boolean, boolean>;
    ...
    purgeErrors: Schema<Schemastery.ObjectS<{
      enabled: Schema<boolean, boolean>;
  ...
  subagents: Schema<Schemastery.ObjectS<{
